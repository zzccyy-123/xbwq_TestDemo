'''
    index_monReport_page页面对象，实现首页中新增月报报的流程
'''
import json
import time
...
class IndexMonReportPage(BasePage):
    """核心元素"""
    # 页面链接
    url = index_url
    # 工作汇报
    ...
    # 周报管理
    ybgl_button = (By.XPATH, '/html/body/div[1]/div[2]/div/ul/li[13]/div/a[3]')
    # 新增日报
    xzyb_button = (By.XPATH, '//a[@data-title="新增月报"]')
    # 日期
    ...
    def mon_report(self, kwargs):
        ...
        self.clike_s(self.ybgl_button)
        self.clike_s(self.xzyb_button)
        # 填写日期
...
if __name__ == '__main__':
    with open('../Test_data/data_monReport.json', 'r', encoding='utf-8') as fp:
        kwargs = json.load(fp)
    driver = webdriver.Chrome()
    IndexMonReportPage(driver).mon_report(**kwargs)
